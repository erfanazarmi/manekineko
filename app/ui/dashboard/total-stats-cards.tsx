...
export default function TotalStatsCards({ from, to }: { from: string; to: string }) {
  ...
  return (
    <div className="flex flex-col gap-3 md:flex-row">
      <div className="flex flex-1 flex-col md:flex xl:flex-row gap-3">
        <div className="flex lg:flex-col justify-between flex-1 rounded-lg p-2 bg-neutral-200 dark:bg-neutral-900 lg:p-3">
          <div className="flex items-center gap-2 font-medium text-sm p-1 lg:p-2 lg:pb-3">
            <PlusCircleIcon className="w-5 text-green-500" />
            Income
          </div>
          <div className="bg-background px-3 py-1 flex justify-center items-center text-lg lg:text-2xl rounded-md lg:p-6">
